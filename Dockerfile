...
#   OLLAMA_HOST       Ollama bind address (default 0.0.0.0, passed to ollama serve)
...
RUN pip3 install --no-cache-dir --break-system-packages "llm-autotune==1.0.7"
