...
MODEL_REGISTRY: dict[str, ModelProfile] = {
    ...
    for m in [
        ...
        ModelProfile(
            ...
            context_window=131072,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q6_K", "Q8_0"],
            description="Qwen 2.5 Coder 14B — best open coding model at this size, near GPT-4o on HumanEval",
        ...
        ModelProfile(
            ...
            description="Qwen3 flagship MoE (22B active) — frontier-level quality, requires 64GB+ RAM at Q2_K",
        ...
        ModelProfile(
            ...
            description="Meta Llama 4 Maverick 400B MoE (17B active, 128E) — multimodal, 1M context, 128GB+ RAM",
