...
MODEL_REGISTRY: dict[str, ModelProfile] = {
    ...
    for m in [
        ...
        ModelProfile(
            ...
            context_window=32768,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q8_0"],
            description="Google Gemma 3n E2B — on-device multimodal (text+vision+audio), MatFormer, ~2GB RAM",
        ...
        ModelProfile(
            ...
            bench_mmlu=0.640, bench_humaneval=0.480,
        ),
        ModelProfile(
            id="gemma4-12b",
            name="Gemma 4 12B",
            ...
            bench_mmlu=0.790, bench_humaneval=0.720,
        ),
        ModelProfile(
            id="gemma-2-9b",
            name="Gemma 2 9B",
        ...
        ModelProfile(
            ...
            context_window=262144,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q6_K", "Q8_0"],
            description="Qwen 3.5 9B — newest mid Qwen, hybrid thinking, 256k context, upgrade over Qwen3 8B",
            hf_repo="Qwen/Qwen3.5-9B",
            ollama_tag="qwen3.5:9b",
            bench_mmlu=0.770, bench_humaneval=0.730,
        ),
        ModelProfile(
            id="gpt-oss-20b",
            ...
            context_window=131072,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q8_0"],
            description="OpenAI GPT-OSS 20B — open-weight MoE (3.6B active), adjustable reasoning, ~o3-mini quality, fits 16GB",
            hf_repo="openai/gpt-oss-20b",
            ollama_tag="gpt-oss:20b",
            bench_mmlu=0.830, bench_humaneval=0.870,
        ),
        ModelProfile(
            id="devstral-24b",
            name="Devstral 24B",
            ...
            context_window=131072,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q6_K", "Q8_0"],
            description="Mistral Devstral 24B — agentic coding specialist for multi-file edits and tool use",
            hf_repo="mistralai/Devstral-Small-2505",
            ollama_tag="devstral:24b",
            bench_mmlu=0.780, bench_humaneval=0.840,
        ),
        ModelProfile(
            id="qwen3.6-27b",
            name="Qwen 3.6 27B",
            ...
            context_window=262144,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q6_K", "Q8_0"],
            description="Qwen 3.6 27B dense — best overall on consumer hardware, 77.2% SWE-bench, fits 24GB at Q4",
            hf_repo="Qwen/Qwen3.6-27B",
            ollama_tag="qwen3.6:27b",
            bench_mmlu=0.860, bench_humaneval=0.900,
        ),
        ModelProfile(
            id="qwen3-coder-30b",
            ...
            context_window=262144,
            quantization_options=["Q4_K_M", "Q5_K_M", "Q6_K", "Q8_0"],
            description="Qwen3-Coder 30B MoE (3.3B active) — top open agentic coder, 256k native context, 7B-class speed",
            hf_repo="Qwen/Qwen3-Coder-30B-A3B-Instruct",
            ollama_tag="qwen3-coder:30b",
            bench_mmlu=0.820, bench_humaneval=0.920,
        ),
        ModelProfile(
            id="gpt-oss-120b",
            ...
            description="OpenAI GPT-OSS 120B — open-weight MoE flagship, near-o3 quality, needs 80GB+ unified memory",
            hf_repo="openai/gpt-oss-120b",
            ollama_tag="gpt-oss:120b",
            bench_mmlu=0.880, bench_humaneval=0.920,
        ),
    ]
}
